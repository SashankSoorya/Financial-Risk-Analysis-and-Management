...
# Read the data
dataset <- read_excel("D:\\Sashank\\AsssignmentRFiles\\Daily.xlsx")

# Ensure the Date column is in Date format
dataset$Date <- as.Date(dataset$Date, format="%Y-%m-%d")

# Define stock column̥s and market return
...
risk_free_column <- "Daily Yield %"  # Assuming this is the risk-free rate column
...
n=3 #Change the values of n=2,3,4,5 to get for different stocks
